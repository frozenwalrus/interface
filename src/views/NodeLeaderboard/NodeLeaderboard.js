...
<Grid container spacing={3} direction="row" style={{ display: 'flex', justifyContent: 'center'}} >
      ...
      <HomeCard>
          ...
          <Grid container spacing={3} style={{ marginBottom: '5%'}} >
            <Grid direction="column" item xs={6} style={{ display: 'flex', alignItems: 'center' }}> 
              <HomeCardPurple style={{ width: '90%' }} >
                  <h2 style={{ fontSize: '32px', textAlign: 'center'}}><u>WLRS-USDC</u></h2>
            ...
            <Grid spacing={6} direction="column" item xs={6} style={{ display: 'flex', alignItems: 'center' }}> 
              <HomeCardBlue style={{ width: '90%'}}>
                <h2 style={{ fontSize: '32px', textAlign: 'center'}}><u>WSHARE-USDC</u></h2>
                <h2 style={{ fontSize: '24px', textAlign: 'center'}}>
                      750820c233<br />
                      33734003d8<br />
                      21cbf49580<br />
        ...
        <h2 style={{ fontSize: '24px', textAlign: 'center', marginBottom: '2%'}}>  
          ...
          <Grid container spacing={6} style={{ marginBottom: '5%'}} >
            ...
            <Grid direction="column" item xs={6} style={{ display: 'flex', alignItems: 'center' }}> 
              <HomeCardPurple style={{ width: '90%' }} >
                <h2 style={{ fontSize: '32px', textAlign: 'center', marginTop:'10%'}}><u>WLRS-USDC</u></h2>
                <h2 style={{ fontSize: '24px', textAlign: 'center', marginBottom: '15%' }}>
                e67E1ac524: 140
            ...
            <Grid spacing={6} direction="column" item xs={6} style={{ display: 'flex', alignItems: 'center' }}> 
              <HomeCardBlue style={{ width: '90%'}}>
                <h2 style={{ fontSize: '32px', textAlign: 'center', marginTop:'10%'}}><u>WSHARE-USDC</u></h2>
                <h2 style={{ fontSize: '24px', textAlign: 'center', marginBottom: '15%' }}>
                e88EeB6141: 435 
                </h2> 
              </HomeCardBlue>
  ...
  <Grid  item xs={12} sm={12}>
    <HomeCard>
      <CardContent>
      <h2 style={{ fontSize: '36px', textAlign: 'center', marginBottom: '2%'}}>
       All-Time Leaderboard<br /> </h2>
       <h2 style={{ fontSize: '28px', textAlign: 'center', marginBottom: '2%'}}>
      ...
      <Grid container spacing={3} >   
        ...
        <HomeCardPurple style={{  width: '90%'}}>
          <h2 style={{ fontSize: '32px', textAlign: 'center'}}><u>WLRS-USDC</u></h2>
          <h2 style={{ fontSize: '24px', textAlign: 'center', justifyContent: 'space-between' }}>
