...
const configurations: { [env: string]: Configuration } = {
  production: {
    ...
    externalTokens: {
      ...
      'WLRS-USDIBS-LP': ['0x26E6E2CbE80A7408573BE67578ee5c10F2984f99', 18],
...
export const bankDefinitions: { [contractName: string]: BankInfo } = {
  ...
  */
  ...
  WlrsUSDibsLPWShareRewardPool: {
    name: 'Earn WSHARE by WLRS-USDibs LP',
    poolId: 3,
    sectionInUI: 2,
    contract: 'WlrsUSDibsLPWShareRewardPool',
    depositTokenName: 'WLRS-USDIBS-LP',
    earnTokenName: 'WSHARE',
    finished: false,
    sort: 3,
    closedForStaking: false,
  ...
  NrwlYusdLPWShareRewardPool: {
    name: 'Earn WSHARE by NRWL-YUSD LP',
    poolId: 4,
    sectionInUI: 2,
  ...
  WShareUSDCWLRSRewardPool: {
    name: 'Earn WLRS with WSHARE-USDC-LP',
    poolId: 8,
    sectionInUI: 0,
  ...
  WlrsUsdcGenesisNrwlRewardPool: {
    name: 'Earn NRWL by WLRS-USDC.e LP',
    poolId: 0,
    sectionInUI: 5,
  ...
  WshareUsdcGenesisNrwlRewardPool: {
    name: 'Earn NRWL by WSHARE-USDC.e LP',
    poolId: 0,
    sectionInUI: 5,
  ...
  WshareGenesisNrwlRewardPool: {
    name: 'Earn NRWL by WSHARE',
    poolId: 0,
    sectionInUI: 5,
    contract: 'WshareGenesisNrwlRewardPool',
    depositTokenName: 'WSHARE',
    earnTokenName: 'NRWL',
    finished: false,
    sort: 4,
    closedForStaking: false,
